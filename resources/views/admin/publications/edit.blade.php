...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.publications.index') }}">Publications Management</a></li>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.publications.update', $publication->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="5" required>{{ old('description', $publication->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="10">{{ old('content', $publication->content ?? '') }}</textarea>
                            <div class="form-text">Optional. If provided, this content will be displayed on the publication detail page.</div>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0">Publication Details</h5>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                        ...
                                        <option value="AFO" {{ old('type', $publication->type) == 'AFO' ? 'selected' : '' }}>Annual Flood Outlook</option>
                                        <option value="Bulletin" {{ old('type', $publication->type) == 'Bulletin' ? 'selected' : '' }}>Bulletin</option>
                                        <option value="Report" {{ old('type', $publication->type) == 'Report' ? 'selected' : '' }}>Report</option>
                                        <option value="Research" {{ old('type', $publication->type) == 'Research' ? 'selected' : '' }}>Research</option>
                                        <option value="Guide" {{ old('type', $publication->type) == 'Guide' ? 'selected' : '' }}>Guide</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('publication_date') is-invalid @enderror" id="publication_date" name="publication_date" value="{{ old('publication_date', $publication->publication_date->format('Y-m-d')) }}" required>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center mt-3">
                                    <div class="image-preview">
                                        <img id="preview" src="{{ $publication->cover_image ?? asset('images/placeholder-200x300.svg') }}" class="img-fluid rounded" alt="Preview">
                                    </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0">Publication File</h5>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                ...
                                <div class="alert alert-secondary mt-2">
                                    <strong>Current File:</strong> {{ basename($publication->file_path) }}
                                </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('admin.publications.index') }}" class="btn btn-secondary">Cancel</a>
                    <div>
...
@section('scripts')
    ...
    <script>
        ...
        const currentImage = "{{ $publication->cover_image ?? asset('images/placeholder-200x300.svg') }}";
